// app/paket/checkout/tiktok/page.tsx
...
export default function CheckoutPage() {
  ...
  // Informasi produk
  const product = {
    image: "https://cdn-icons-png.flaticon.com/128/17630/17630316.png", // Ganti dengan URL gambar produk asli
  ...
  const handleCheckout = () => {
    ...
    router.push('/paket/pembayaran/course/webdev');
  };
