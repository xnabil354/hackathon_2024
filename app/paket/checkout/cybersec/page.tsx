// app/paket/checkout/youtube/page.tsx
...
export default function CheckoutPage() {
  ...
  // Informasi produk
  const product = {
    image: "https://cdn-icons-png.flaticon.com/128/1797/1797588.png", // Ganti dengan URL gambar produk asli
  ...
  const handleCheckout = () => {
    ...
    router.push('/paket/pembayaran/course/cybersec');
  };
