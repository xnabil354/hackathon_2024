  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col justify-between relative">
      ...
      <section className="flex flex-col items-center p-4 flex-grow mb-14">
        ...
        >
          3 Langkah Mudah Belajar Marketing Pariwisata <br /> Platform Youtube
        </motion.h1>
        ...
        <div className="relative w-full max-w-4xl space-y-8"> 
          ...
          >
            ...
            <div className="w-2/3">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-2">Membuat Akun Youtube</h2>
              <p className="text-gray-600 text-sm mb-2">
                Langkah awal membuat akun pada platform Youtube, platform ini menyediakan banyak opsi untuk mendaftar.
              </p>
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => handleNavigation('/platform/youtube/register-akun')}
              >
                Pelajari
              </motion.button>
            </div>
          ...
          >
            <div className="w-2/3 text-right">
              ...
              <p className="text-gray-600 text-sm mb-2">
                Langkah kedua membuat profil yang menarik pada platform Youtube untuk menarik lebih banyak pengikut.
              </p>
              <motion.button 
                className="px-4 py-2 bg-lime-500 text-white font-semibold rounded-full shadow-lg transform transition-transform hover:scale-110 hover:bg-lime-600 text-sm"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => handleNavigation('/platform/youtube/membuat-profile')}
              >
                Pelajari
              </motion.button>
            </div>
          ...
          >
            ...
            <div className="w-2/3">
              ...
              <p className="text-gray-600 text-sm mb-2">
                Langkah ketiga adalah membuat konten yang menarik, kreatif, dan relevan untuk meningkatkan engagement di Youtube.
              </p>
              <motion.button 
                className="px-4 py-2 bg-lime-500 text-white font-semibold rounded-full shadow-lg transform transition-transform hover:scale-110 hover:bg-lime-600 text-sm"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => handleNavigation('/platform/youtube/content-creator')}
              >
                Pelajari
              </motion.button>
            </div>
