  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col justify-between relative">
      ...
      <section className="flex flex-col items-center p-4 flex-grow mb-14">
        ...
        >
          3 Langkah Mudah Belajar Marketing Pariwisata <br /> Platform Instagram
        </motion.h1>
        ...
        <div className="relative w-full max-w-4xl space-y-8"> 
          ...
          >
            <div className="w-1/3">
              <div className="relative w-full h-40">
                <Image
                  src="https://k.top4top.io/p_3204k8clu1.png" 
                  alt="Membuat Akun Instagram"
                  layout="fill"
            ...
            <div className="w-2/3">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-2">Membuat Akun Instagram</h2>
              <p className="text-gray-600 text-sm mb-2">
              Mulai perjalanan marketing Anda dengan langkah pertama: membuat akun Instagram yang mudah dan cepat.
              </p>
              <motion.button 
          ...
          >
            <div className="w-2/3 text-right">
              ...
              <p className="text-gray-600 text-sm mb-2">
              Profil yang menarik adalah wajah pertama bisnis Anda. Pastikan profil TikTok Anda merepresentasikan identitas dan daya tarik utama.
              </p>
              <motion.button 
                className="px-4 py-2 bg-lime-500 text-white font-semibold rounded-full shadow-lg transform transition-transform hover:scale-110 hover:bg-lime-600 text-sm"
                whileHover={{ scale: 1.1 }}
            ...
            <div className="w-1/3">
              <div className="relative w-full h-40">
                <Image
                  src="https://l.top4top.io/p_3204e6qiw2.png" 
          ...
          >
            <div className="w-1/3">
              <div className="relative w-full h-40">
                <Image
                  src="https://a.top4top.io/p_32043q5it3.png" 
            ...
            <div className="w-2/3">
              ...
              <p className="text-gray-600 text-sm mb-2">
              Konten kreatif adalah kunci untuk memikat audiens. Mulailah merencanakan video yang relevan dan inspiratif untuk promosi pariwisata Anda.
              </p>
              <motion.button 
                className="px-4 py-2 bg-lime-500 text-white font-semibold rounded-full shadow-lg transform transition-transform hover:scale-110 hover:bg-lime-600 text-sm"
                whileHover={{ scale: 1.1 }}
